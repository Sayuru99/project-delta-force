  ...
  <main className="flex items-center justify-center min-h-screen flex-col">
    ...
    <section className="p-10">
      ...
      <div className="grid md:grid-cols-4 gap-0">
        <ImageCard
          image="src/assets/images/home/testimg1.jpg"
          name="Antonio Boulos"
          title="President"
        />
        <ImageCard
          image="src/assets/images/home/testimg1.jpg"
          name="Carlos Yeghiazarian"
        ...
        <ImageCard
          image="src/assets/images/home/testimg1.jpg"
          name="Naji Younes"
          title="Head of Research & Strategy"
        />
      </div>
    </section>
      ...
      <div className="flex flex-col md:flex-row gap-10">
        ...
        <div className="md:w-1/3">
          ...
          <p className="mb-2">
            Antonio Boulos:{" "}
            <a
              href="mailto:antonio.boulos@bpnmena.com"
          ...
          <p>
            Carlos Yeghiazarian:{" "}
            <a
              href="mailto:carlos.yeghiazarian@bpnmena.com"
              className="text-orange-400"
            >
